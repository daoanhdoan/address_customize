...
/**
 * Plugin implementation of the 'address_customize' formatter.
 *
 * @FieldFormatter(
 ...
 * )
 */
class AddressCustomizePlainFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
  ...
  protected function viewElement(AddressInterface $address, $langcode) {
    ...
    if(!empty($values['locality']) && !isset($values['locality']['code'])) {
      $values['locality'] = [
        'code' => $values['locality']
      ];
    }
    if(!empty($values['dependentLocality']) && !isset($values['dependentLocality']['code'])) {
      $values['dependentLocality'] = [
        'code' => $values['dependentLocality']
      ];
    }
    $element = [
      '#theme' => 'address_plain',
